from src.api.api_interaction import create_list
...
def test_create_and_verify_list(driver, setup_session):
    ...
    assert open_library_page.verify_list_exists("automation_list"), "List not found in UI"
